...
set(OMEGA_SW_EXE_NAME             "omega_sw.exe")
...
macro(update_variables)
  ...
  if(OMEGA_MEMORY_LAYOUT)
    ...
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DOMEGA_LAYOUT_${_LAYOUT}")
  else()
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DOMEGA_LAYOUT_RIGHT")
  endif()

  if(OMEGA_TILE_LENGTH)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DOMEGA_TILE_LENGTH=${OMEGA_TILE_LENGTH}")
  endif()
